<?php
/**
 * Mes films — vue bibliothèque (tranches verticales).
 *
...
$shelfSortLink = static function (string $label, string $column) use ($sortBy, $sortDir, $query, $kindFilter, $viewMode): void {
...
<div class="collection-grid-bar game-shelf-bar">
    ...
    <nav class="collection-grid-sort" aria-label="Trier">
        ...
        <?php $shelfSortLink('Dernière vue', 'derniere_vue'); ?>
    </nav>
</div>
