...
<div class="game-detail-sidebar__actions"
     data-game-detail-actions
     <?= $popoverOpen !== '' ? ' data-popover-open="' . Moncine\View::escape($popoverOpen) . '"' : '' ?>>
    <div class="game-action-popover-anchor" data-game-action-anchor="note">
        <button type="button" class="btn btn-icon btn-secondary btn-sm" data-game-action="note"
        ...
        <div class="game-action-popover" id="game-popover-note" data-game-popover="note" role="dialog"
    ...
    <?php if ($showPlaytimeAction): ?>
        <div class="game-action-popover-anchor" data-game-action-anchor="playtime">
            <button type="button" class="btn btn-icon btn-secondary btn-sm" data-game-action="playtime"
            ...
            <div class="game-action-popover" id="game-popover-playtime" data-game-popover="playtime" role="dialog"
    ...
    <div class="game-action-popover-anchor" data-game-action-anchor="edit">
        <button type="button" class="btn btn-icon btn-secondary btn-sm" data-game-action="edit"
        ...
        <div class="game-action-popover" id="game-popover-edit" data-game-popover="edit" role="dialog"
    ...
    <?php if ($showFinishAction): ?>
        <div class="game-action-popover-anchor" data-game-action-anchor="finish">
            <button type="button" class="btn btn-icon btn-secondary btn-sm" data-game-action="finish"
            ...
            <div class="game-action-popover" id="game-popover-finish" data-game-popover="finish" role="dialog"
