<?php
/**
 * Pagination de la grille numéros (48 par page).
 *
 * @var int $seriesId
 * @var int $page
 * @var int $totalPages
...
$pageLink = static function (int $targetPage) use (
    ...
    return Moncine\View::magazineSeriesUrl($seriesId, $sortBy, $sortDir, $params) . '#magazine-issues-grid';
};

$gotoPageId = 'magazine_goto_page' . $paginationIdSuffix;
?>
<nav class="list-pager magazine-issues-pager" aria-label="Pagination des numéros">
    ...
    <form method="get" action="/serie-magazine.php#magazine-issues-grid" class="list-pager__goto magazine-issues-pager__goto">
