<?php
/**
 * Boutons d’action rapide fiche livre : ressenti, modifier, marquer lu.
 *
...
<div class="game-detail-sidebar__actions"
    ...
    <div class="game-action-popover-anchor" data-detail-action-anchor="note">
        <button type="button" class="btn btn-icon btn-secondary btn-sm" data-detail-action="note"
                ...
                aria-controls="livre-popover-note">
            <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                <path fill="currentColor" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
            </svg>
        </button>
        <div class="game-action-popover" id="livre-popover-note" data-detail-popover="note" role="dialog"
            ...
            <div class="game-action-popover__panel">
                ...
                <?php require MONCINE_ROOT . '/templates/_marquer_livre_ressenti_form.php'; ?>
            </div>
        </div>
    </div>
    ...
    <div class="game-action-popover-anchor" data-detail-action-anchor="edit">
        <button type="button" class="btn btn-icon btn-secondary btn-sm" data-detail-action="edit"
                title="Modifier ce livre" aria-label="Modifier ce livre"
                aria-expanded="<?= $popoverOpen === 'edit' ? 'true' : 'false' ?>"
                aria-controls="livre-popover-edit">
            <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        ...
        <div class="game-action-popover" id="livre-popover-edit" data-detail-popover="edit" role="dialog"
             aria-label="Modifier ce livre" hidden>
            <div class="game-action-popover__panel game-action-popover__panel--wide">
                <p class="game-action-popover__title">Modifier ce livre</p>
                <?php if ($editError !== '' && $popoverOpen === 'edit'): ?>
                    <div class="alert alert-warning"><?= Moncine\View::escape($editError) ?></div>
                <?php endif; ?>
                <p class="hint">
                    <a href="<?= Moncine\View::escape(Moncine\View::livreEditUrl($bookId)) ?>">
                        Ouvrir la page de modification complète
                    </a>
                </p>
                <form method="post" action="/enregistrer-modification-livre.php"
                      enctype="multipart/form-data" class="import-form film-edit-form" data-livre-form>
    ...
    <div class="game-action-popover-anchor" data-detail-action-anchor="lu">
        <button type="button" class="btn btn-icon btn-secondary btn-sm" data-detail-action="lu"
                ...
                aria-controls="livre-popover-lu">
            <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                <path fill="currentColor" d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
            </svg>
        </button>
        <div class="game-action-popover" id="livre-popover-lu" data-detail-popover="lu" role="dialog"
            ...
            <div class="game-action-popover__panel">
                ...
                require MONCINE_ROOT . '/templates/_marquer_livre_lu_form.php';
                ?>
            </div>
        </div>
    </div>
