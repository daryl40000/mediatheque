...
<section class="collection-page share-visitor-page">
    ...
    <?php else:
        ...
        <form method="get" action="/partage-magazines.php" class="collection-search import-form">
            ...
            <?php endif; ?>
            <label for="share_mag_q">Rechercher une série</label>
            <div class="collection-search__row">
                <input type="search" name="q" id="share_mag_q"
        ...
        <?php else: ?>
            ...
            <div class="magazine-series-grid">
                <?php foreach ($seriesList as $series): ?>
                    ...
                    $seriesUrl = Moncine\ShareLinkService::magazineSeriesUrl(
                        $rawToken,
                        $seriesId,
                    ...
                    $catalogCount = (int) ($series['catalog_issue_count'] ?? 0);
                    ?>
