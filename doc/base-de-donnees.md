...
**Version : 0.5.6** · **Moteur :** SQLite (`data/moncine.db`) · **Schéma de référence :** [`sql/schema.sql`](../sql/schema.sql)
...
*Dernière mise à jour : **0.5.6** (2026-06-16) — sagas jeux, doc base de données, correctif filtre genre multi-tags.*
