...
| Version | Contenu |
|---------|---------|
| **0.8.3** | Jeux : carte stats Remakes (liste remake / original avec jaquettes) |
...
| **0.7.39** | Magazines : case HS à la modif, ordre de tri catalogue ; catalogue : tri par ID |
| **0.7.38** | Magazines : Jeux offerts — badge Linux + liens fiche jeu / magazine |
| **0.7.37** | Magazines : liste Jeux offerts + correctifs stats période |
...
| **0.7.26** | Magazines : stats d’évolution par série + CI GitHub Actions |
