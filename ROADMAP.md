...
**Version actuelle : 0.7.42** (2026-07-26)  
...
| **Transversal** | 🔄 Partiel | **0.7.12**–**0.7.42** | Recherche globale, catalogue admin, import/export multi-médias, profil → fiches, partage, connexion pseudo, UI Compte/Import, menu mobile, PWA, CI |
...
*Dernière mise à jour : **0.7.42** — 2026-07-26 (Jeux : multi-PDF manuels/soluces + bulles d’aide).*
