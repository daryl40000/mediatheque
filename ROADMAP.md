...
**Version actuelle : 0.7.38** (2026-07-23)  
...
| **Transversal** | 🔄 Partiel | **0.7.12**–**0.7.38** | Recherche globale, catalogue admin, import/export multi-médias, profil → fiches, partage, connexion pseudo, UI Compte/Import, menu mobile, PWA, CI |
...
*Dernière mise à jour : **0.7.38** — 2026-07-23 (Magazines : Jeux offerts — badge Linux + liens fiches).*
